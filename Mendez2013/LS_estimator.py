...
"""ESTIMATION USING THE LEAST SQUARES ESTIMATOR."""
...
F_LOW_SNR = 740                                     # Total flux value for LOW_SNR (ADU)
F_HIGH_SNR = 12050                                  # Total flux value for HIGH_SNR (ADU)
...
def main():
    ...
    # Compute stimators for LOW_SNR
    estimated_x_c_LOW_SNR = fn.estimate_x_c_for_simulations_WLS(data_LOW_SNR, 'uniform', F_LOW_SNR, fs, delta_x, n_pix, D, RON, G, FWHM, INITIAL_GUESS)
    ...
    estimated_x_c_HIGH_SNR = fn.estimate_x_c_for_simulations_WLS(data_HIGH_SNR,'uniform', F_HIGH_SNR, fs, delta_x, n_pix, D, RON, G, FWHM, INITIAL_GUESS)
